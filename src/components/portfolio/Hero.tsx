      ...
      <div className="max-w-7xl mx-auto px-6 py-32 grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-md mb-8 leading-relaxed">
            Passionnée par la Cybersécurité, le Réseau et le Développement. 
            Basée à Lille, je conçois des solutions numériques innovantes.
          </p>
          ...
          <div className="flex items-center gap-4">
            {[
              ...
              { icon: ExternalLink, href: "https://osaoui.free.nf/atelier_des_jeux/login.php" },
              ...
              <a
                ...
                title={href.includes('mailto') ? 'Envoyer un mail' : 'Ouvrir le lien'}
              >
                <Icon size={18} />
              </a>
            ))}
